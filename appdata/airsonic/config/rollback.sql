...
-- Lock Database
UPDATE PUBLIC.DATABASECHANGELOGLOCK SET LOCKED = TRUE, LOCKEDBY = '172.25.0.1 (172.25.0.1)', LOCKGRANTED = '2023-05-08 14:38:18.568' WHERE ID = 1 AND LOCKED = FALSE;
