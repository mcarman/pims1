...
-- Lock Database
UPDATE PUBLIC.DATABASECHANGELOGLOCK SET LOCKED = TRUE, LOCKEDBY = '3cd3e4eb1a75 (172.23.0.11)', LOCKGRANTED = '2023-06-03 15:16:51.814' WHERE ID = 1 AND LOCKED = FALSE;
