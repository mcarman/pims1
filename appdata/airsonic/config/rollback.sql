...
-- Lock Database
UPDATE PUBLIC.DATABASECHANGELOGLOCK SET LOCKED = TRUE, LOCKEDBY = '172.22.0.1 (172.22.0.1)', LOCKGRANTED = '2023-05-10 11:12:14.368' WHERE ID = 1 AND LOCKED = FALSE;
