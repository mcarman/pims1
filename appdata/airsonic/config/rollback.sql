...
-- Lock Database
UPDATE PUBLIC.DATABASECHANGELOGLOCK SET LOCKED = TRUE, LOCKEDBY = '57f577c141a9 (172.19.0.12)', LOCKGRANTED = '2023-06-17 06:31:54.317' WHERE ID = 1 AND LOCKED = FALSE;
