...
-- Lock Database
UPDATE PUBLIC.DATABASECHANGELOGLOCK SET LOCKED = TRUE, LOCKEDBY = '57f577c141a9 (172.19.0.9)', LOCKGRANTED = '2023-06-11 13:50:06.987' WHERE ID = 1 AND LOCKED = FALSE;
